export const faqItems = [
  {
    ...
    answer:
      "O ideal é realizar consultas ginecológicas anualmente para exames preventivos, como o Papanicolau. No entanto, a frequência pode variar de acordo com sua idade, histórico médico e necessidades específicas. Mulheres com condições ginecológicas podem precisar de acompanhamento mais frequente.",
  },
  {
    question: "Como é a primeira consulta ginecológica?",
    answer:
      "A primeira consulta é um momento de acolhimento e conversa. Vamos conversar sobre seu histórico de saúde, ciclo menstrual, hábitos e eventuais queixas. O exame físico só é realizado com seu consentimento e de forma gentil. Não há motivo para preocupação — estou aqui para cuidar de você com todo o respeito e carinho.",
  },
  {
    question: "Quais métodos contraceptivos você oferece?",
    answer:
  ...
  },
  {
    ...
    answer:
      "Você pode agendar sua consulta pelo WhatsApp clicando no botão 'Agendar Consulta' aqui no site. Minha equipe vai te atender com carinho e encontrar o melhor horário para você. Também pode ligar diretamente para o consultório.",
  },
] as const;
