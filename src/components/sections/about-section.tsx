      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div ref={ref} className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center mt-8">
          ...
          <div className="relative h-[500px] lg:h-[600px]">
            ...
            <motion.div
              style={{ y: y1 }}
              className="absolute top-0 left-0 w-64 sm:w-72 h-80 sm:h-96 rounded-3xl overflow-hidden shadow-xl shadow-navy-900/10 z-10"
            >
              <Image
            ...
            <motion.div
              style={{ y: y2 }}
              className="absolute bottom-0 right-0 sm:right-8 w-56 sm:w-64 h-72 sm:h-80 rounded-3xl overflow-hidden shadow-xl shadow-navy-900/10 border-4 border-white"
            >
              <Image
          ...
          <div>
            <FadeIn direction="right">
              <p className="text-lg leading-relaxed text-navy-700/80 mb-6">
                ...
                as mulheres. Com 28 anos, sou uma mulher negra e feminista que
                acredita que toda mulher merece um atendimento respeitoso,
            ...
            <div className="space-y-4">
              {credentials.map((cred, i) => (
                <FadeIn key={i} direction="right" delay={0.2 + i * 0.1}>
                  <div className="flex items-start gap-3 p-4 rounded-xl bg-white/60 backdrop-blur-sm border border-jade-100/50">
